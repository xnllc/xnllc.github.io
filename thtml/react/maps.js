(function(config) {
    ...
    var na = "microsoft basic render driver;vmware svga 3d;Intel 965GM;Intel B43;Intel G41;Intel G45;Intel G965;Intel GMA 3600;Intel Mobile 4;Intel Mobile 45;Intel Mobile 965".split(";"),
        ...
        wa = ua && !va;
    e("windows nt 10");
    var xa = e("windows phone"),
        ya = e("macintosh"),
        za = e("Mb2345Browser"),
        Aa = e("ipad;") || e("ipad "),
        Ba = Aa && qa,
        Ca = e("ipod touch;"),
        Da = e("iphone;") || e("iphone "),
        Ea = Da || Aa || Ca,
    ...
    var Ia = Ea && e("os 10_"),
        La = e("android"),
        Ma = -1 !== ba.search(/android [123]/),
        Na = e("android 4");
    La && -1 === ba.search(/android [1-4]/) || ba.search(/android 4.4/);
    var Oa = La ? "android" : Ea ? "ios" : sa ? "windows" : ya ? "mac" : "other",
        Pa = pa && !da.XMLHttpRequest,
        Qa = pa && !ea.querySelector,
        Ra = pa && !ea.addEventListener,
        Sa = pa && e("ie 9"),
        Ta = pa && e("msie 10"),
        Ua = pa && e("rv:11"),
        Wa = e("alipay") || La && Va,
        ...
        ab = e("mqqbrowser"),
        bb = e("baidubrowser"),
        chrome = (e("chrome") || e("crios")) && !$a && !bb && !ab && !Xa && !Za,
        cb = chrome && e("chromium"),
        db = chrome && !cb && 30 < parseInt(ba.split("chrome/")[1]),
        eb = e("firefox"),
        fb = eb &&
            27 < parseInt(ba.split("firefox/")[1]),
        gb = (ya || Ea) && e("safari") && e("version/"),
        hb = ya && gb && 7 < parseInt(ba.split("version/")[1]),
        ib = Ea && e("aliapp"),
        jb = Ea && (!ab && !Va && !$a && !chrome && !eb && !gb || ib),
        kb = La || Ea || xa || e("mobile"),
        lb = da.navigator && da.navigator.msPointerEnabled && !! da.navigator.msMaxTouchPoints,
        mb = da.navigator && da.navigator.pointerEnabled && !! da.navigator.maxTouchPoints,
        nb = mb || lb,
        ob = "ontouchstart" in ea || nb,
        pb = function() {
        ...
        qb = qa && (!kb || !! pb && 1 <= pb),
        rb = pa && "transition" in ja.style,
        sb = !! ea.createElementNS && !! ea.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
        vb = ea.createElement("canvas"),
        wb = !(!vb || !vb.getContext),
        xb = window.URL || window.webkitURL,
        yb = !pa && !(Va && La) && window.Worker && xb && xb.createObjectURL && window.Blob,
        zb = "",
        ma = "",
        Ab = 0,
        Bb = {
        ...
        Db = Cb && !kb && (db || fb || hb) && ("mac" == Oa || "windows" == Oa),
        Eb = !wb || Ya || xa || kb && eb || Sa ||
            Ga || Ba || Ca || Ma || e("gt-n710") || wa,
        Fb = !Eb && !Db && (Na || Ha || Ea && $a || !kb),
        Gb = Db ? "vw" : Eb ? "d" : Fb ? "dv" : "v",
        Hb = e("webkit"),
        Ib = "WebKitCSSMatrix" in da && "m11" in new window.WebKitCSSMatrix,
        Jb = "MozPerspective" in ja.style,
        Kb = "OTransition" in ja.style,
        Lb = rb || Ib || Jb || Kb,
    ...
    config.Fd += "c";
    config.j.cf && (config.Fd += "v", Tb += ",vectorlayer,overlay", config.j.Tn ? (config.Fd += "w", Tb += ",wgl") : (config.Fd += "cg", Tb += ",cmng,cgl"));
    if (config[7]) {
    ...
    window.AMap.zi = "1.3.27.4";
    var Xb = window.AMap.vC = {}, Yb = config[2].split(",")[0],
        Zb = Yb + "/theme/v" + config[4] + "/style1.3.27.4.css",
    ...
    function pc() {
        for (var a = Yb + "/maps/main?v=" + config[4] + "&key=" + config[0] + "&m=" + config.eN.join(",") + "&vrs=1.3.27.4", b = document.getElementsByTagName("script"), c, d = 0; d < b.length; d += 1)
            if (0 === b[d].src.indexOf(Yb.split(":")[1] + "/maps?")) {
                c = b[d];
                break
            }
    ...
    try {
        if (window.localStorage) {
            var rc = window.localStorage["_AMap_" + config.Fd],
                sc = !1;
            rc ? (rc = JSON.parse(rc), rc.version === window.AMap.zi ? (eval(rc.script), Xb.loaded = !0) : sc = !0) : sc = !0;
            if (sc)
                for (V in window.localStorage) window.localStorage.hasOwnProperty(V) && 0 === V.indexOf("_AMap_") && window.localStorage.removeItem(V)
        }
    } catch (tc) {}
    Xb.loaded || (pc(), config.eN = void 0);
})(["84742c3f99a5f02d31f5f08bb763cb1b", [120.856804, 30.675593, 122.247149, 31.872716, 121.472644, 31.231706], "http://webapi.amap.com", 1, "1.3", null, "310000", "", true, true, true])